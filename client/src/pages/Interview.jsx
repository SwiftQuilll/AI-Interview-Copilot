  ...
  return (
    <div className="min-h-screen bg-gray-100 text-black dark:bg-gray-900 dark:text-white">
      ...
      <div className="max-w-5xl mx-auto p-8">
        <h1 className="text-4xl font-bold mb-6">AI Interview Questions</h1>
        ...
        <div className="mt-8 space-y-4">
          {questions.map((item, index) => (
            <div key={index} className="bg-white dark:bg-gray-800 p-5 rounded-xl shadow">
              <span className="bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-200 px-3 py-1 rounded">
                {item.type}
              </span>
              <p className="mt-3 font-medium">{item.question}</p>
              <button
        ...
        {selectedQuestion && (
          <div className="mt-10 bg-white dark:bg-gray-800 p-6 rounded-xl shadow">
            ...
            <p className="mb-4">{selectedQuestion}</p>
            <textarea
              rows="6"
              value={answer}
              onChange={(e) => setAnswer(e.target.value)}
              placeholder="Write your answer here..."
              className="w-full border dark:border-gray-700 bg-transparent p-3 rounded"
            />
            <button
        ...
        {evaluation && (
          <div className="mt-8 space-y-4">
            <div className="bg-green-100 dark:bg-green-900 text-green-900 dark:text-green-100 p-5 rounded-xl">
              <h3 className="text-2xl font-bold">Score: {evaluation.score}/10</h3>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-5 rounded-xl shadow">
              <h3 className="font-bold mb-2">Improved Answer</h3>
              <div className="whitespace-pre-wrap">{evaluation.improvedAnswer}</div>
            </div>
          </div>
        )}
      </div>
