...
function ResumeUpload() {
  ...
  return (
    <div>
      <div className="border-2 border-dashed border-gray-300 dark:border-gray-700 p-8 rounded-xl bg-gray-50 dark:bg-gray-900">
        ...
        <button
          ...
          className="bg-blue-600 text-white px-5 py-2 rounded-lg hover:bg-blue-700 block"
        >
          Upload Resume
        </button>
      </div>
